                        ...
                        <Card>
                            <div>
                                <div style={{ display: 'flex' }}>
                                    <p style={{ width: '80px', textAlign: 'left', marginRight: '10px',fontWeight : 'bold'}}>Name </p>
                                    <p>: {Data.fname}</p>
                                </div>
                                <div style={{ display: 'flex' }}>
                                    <p style={{ width: '80px', textAlign: 'left', marginRight: '10px',fontWeight : 'bold' }}>DOB </p>
                                    <p>: {Data.dob}</p>
                                </div>
                                <div style={{ display: 'flex' }}>
                                    <p style={{ width: '80px', textAlign: 'left', marginRight: '10px',fontWeight : 'bold' }}>Gender </p>
                                    <p>: {Data.gender}</p>
                                </div>
                                <div style={{ display: 'flex' }}>
                                    <p style={{ width: '80px', textAlign: 'left', marginRight: '10px',fontWeight : 'bold' }}>Email </p>
                                    <p style={{fontSize : "15px",width : '130px'}}>: {Data.email}</p>
                                </div>
                                <div style={{ display: 'flex' }}>
                                    <p style={{ width: '80px', textAlign: 'left', marginRight: '10px',fontWeight : 'bold' }}>Phone </p>
                                    <p>: {Data.phone}</p>
                                </div>
                                <div style={{ display: 'flex' }}>
                                    <p style={{ width: '80px', textAlign: 'left', marginRight: '10px',fontWeight : 'bold' }}>Address </p>
                                    <p>: {Data.address}</p>
                                </div>
                                <div style={{ display: 'flex' }}>
                                    <p style={{ width: '80px', textAlign: 'left', marginRight: '10px',fontWeight : 'bold' }}>State </p>
                                    <p>: {Data.state}</p>
                                </div>
                                <div style={{ display: 'flex' }}>
